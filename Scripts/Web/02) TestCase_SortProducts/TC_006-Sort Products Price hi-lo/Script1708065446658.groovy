...
backpack = WebUI.getText(findTestObject('Object Repository/Products/1) Sauce Labs/Backpack/product_Price'))
bikelight = WebUI.getText(findTestObject('Object Repository/Products/1) Sauce Labs/Bike Light/product_Price'))
bolttshirt = WebUI.getText(findTestObject('Object Repository/Products/1) Sauce Labs/Bolt T-Shirt/product_Price'))
fleecejacket = WebUI.getText(findTestObject('Object Repository/Products/1) Sauce Labs/Fleece Jacket/product_Price'))
onesie = WebUI.getText(findTestObject('Object Repository/Products/1) Sauce Labs/Onesie/product_Price'))
testtshirt = WebUI.getText(findTestObject('Object Repository/Products/1) Sauce Labs/Test T-Shirt/product_Price'))

// onesie < bikelight < bolttshirt < testtshirt < backpack < fleecejacket
...
WebUI.click(findTestObject('Object Repository/Products/0) Sort Dropdown/option_Hilo'))
