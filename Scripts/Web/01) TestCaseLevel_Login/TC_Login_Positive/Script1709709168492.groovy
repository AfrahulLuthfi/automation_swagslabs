...
WebUI.verifyElementPresent(findTestObject('Object Repository/LandingPage/hamburger_Btn'), 0)

WebUI.click(findTestObject('Object Repository/LandingPage/hamburger_Btn'))

WebUI.verifyElementPresent(findTestObject('Object Repository/LandingPage/logout_Btn'), 0)
