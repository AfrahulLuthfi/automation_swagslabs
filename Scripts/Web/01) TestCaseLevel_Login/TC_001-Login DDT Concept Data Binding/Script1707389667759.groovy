...
if (usn != 'none'){
	WebUI.setText(findTestObject('Object Repository/Login Page/username_Field'), usn)
}
if (psw != 'none') {
	WebUI.setText(findTestObject('Object Repository/Login Page/password_Field'), psw)
}
